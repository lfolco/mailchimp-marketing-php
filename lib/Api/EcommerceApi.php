...
class EcommerceApi
{
    ...
    public function setOrder($store_id, $order_id, $body)
    {
        $response = $this->setOrderWithHttpInfo($store_id, $order_id, $body);
        return $response;
    }

    public function setOrderWithHttpInfo($store_id, $order_id, $body)
    {
        $request = $this->setOrderRequest($store_id, $order_id, $body);
    ...
    protected function setOrderRequest($store_id, $order_id, $body)
    {
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function createOrUpdateStoreProduct($store_id, $product_id, $body)
    {
        $response = $this->createOrUpdateStoreProductWithHttpInfo($store_id, $product_id, $body);
        return $response;
    }

    public function createOrUpdateStoreProductWithHttpInfo($store_id, $product_id, $body)
    {
        $request = $this->createOrUpdateStoreProductRequest($store_id, $product_id, $body);
    ...
    protected function createOrUpdateStoreProductRequest($store_id, $product_id, $body)
    {
        // verify the required parameter 'store_id' is set
        if ($store_id === null || (is_array($store_id) && count($store_id) === 0)) {
            throw new \InvalidArgumentException(
