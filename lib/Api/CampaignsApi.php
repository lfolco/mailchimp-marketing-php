...
class CampaignsApi
{
    ...
    public function list($fields = null, $exclude_fields = null, $count = '10', $offset = '0', $type = null, $status = null, $before_send_time = null, $since_send_time = null, $before_create_time = null, $since_create_time = null, $list_id = null, $folder_id = null, $member_id = null, $sort_field = null, $sort_dir = null, $include_resend_shortcut_eligibility = null)
    {
        $response = $this->listWithHttpInfo($fields, $exclude_fields, $count, $offset, $type, $status, $before_send_time, $since_send_time, $before_create_time, $since_create_time, $list_id, $folder_id, $member_id, $sort_field, $sort_dir, $include_resend_shortcut_eligibility);
        return $response;
    }

    public function listWithHttpInfo($fields = null, $exclude_fields = null, $count = '10', $offset = '0', $type = null, $status = null, $before_send_time = null, $since_send_time = null, $before_create_time = null, $since_create_time = null, $list_id = null, $folder_id = null, $member_id = null, $sort_field = null, $sort_dir = null, $include_resend_shortcut_eligibility = null)
    {
        $request = $this->listRequest($fields, $exclude_fields, $count, $offset, $type, $status, $before_send_time, $since_send_time, $before_create_time, $since_create_time, $list_id, $folder_id, $member_id, $sort_field, $sort_dir, $include_resend_shortcut_eligibility);
    ...
    protected function listRequest($fields = null, $exclude_fields = null, $count = '10', $offset = '0', $type = null, $status = null, $before_send_time = null, $since_send_time = null, $before_create_time = null, $since_create_time = null, $list_id = null, $folder_id = null, $member_id = null, $sort_field = null, $sort_dir = null, $include_resend_shortcut_eligibility = null)
    {
        ...
        // query params
        if ($include_resend_shortcut_eligibility !== null) {
            $queryParams['include_resend_shortcut_eligibility'] = ObjectSerializer::toQueryValue($include_resend_shortcut_eligibility);
        }
    ...
    public function get($campaign_id, $fields = null, $exclude_fields = null, $include_resend_shortcut_eligibility = null, $include_resend_shortcut_usage = null)
    {
        $response = $this->getWithHttpInfo($campaign_id, $fields, $exclude_fields, $include_resend_shortcut_eligibility, $include_resend_shortcut_usage);
        return $response;
    }

    public function getWithHttpInfo($campaign_id, $fields = null, $exclude_fields = null, $include_resend_shortcut_eligibility = null, $include_resend_shortcut_usage = null)
    {
        $request = $this->getRequest($campaign_id, $fields, $exclude_fields, $include_resend_shortcut_eligibility, $include_resend_shortcut_usage);
    ...
    protected function getRequest($campaign_id, $fields = null, $exclude_fields = null, $include_resend_shortcut_eligibility = null, $include_resend_shortcut_usage = null)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if ($include_resend_shortcut_usage !== null) {
            $queryParams['include_resend_shortcut_usage'] = ObjectSerializer::toQueryValue($include_resend_shortcut_usage);
        }
    ...
    public function createResend($campaign_id, $body = null)
    {
        $response = $this->createResendWithHttpInfo($campaign_id, $body);
        return $response;
    }

    public function createResendWithHttpInfo($campaign_id, $body = null)
    {
        $request = $this->createResendRequest($campaign_id, $body);
    ...
    protected function createResendRequest($campaign_id, $body = null)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
